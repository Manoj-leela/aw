...
import sg.activewealth.roboadvisor.infra.enums.ApplicationViewEnum;
...
public class UserSessionDto extends AbstractDto {
	...
	public UserSessionDto(String userId, Timestamp loggedInOn, Timestamp lastAccessedOn, String hashSalt) {
		super();
		this.userId = userId;
	...
	public void setValuesToPersistAcrossRequests(
			Map<String, Object> valuesToPersistAcrossRequests) {
