...
public class EnumStringUserType implements UserType, ParameterizedType {
	...
	public void setParameterValues(Properties parameters) {
		String enumClassName = parameters.getProperty("enumStringClassName"); //parameter which holds enumClassName
		try {
	...
	public Object nullSafeGet(ResultSet rs, String[] names, SessionImplementor session, Object owner)
		...
		throw new HibernateException("Value " + value + " is not found in " + enumClass.getCanonicalName());
	}
